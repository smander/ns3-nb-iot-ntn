...
protected:
  ...
  uint64_t m_minSchedulingDelayDci2Downlink = 4;
  uint64_t m_minSchedulingDelayDci2Uplink = 8;
  uint64_t m_ntnKOffset = 0; ///< NTN k-Offset in subframes (TR 36.763 Sec 6.3.1)
  bool m_log;
