...
LteUeRrc::LteUeRrc ()
  : m_cmacSapProvider (0),
    ...
    m_hasReceivedSib31Nb (false),
    m_hasReceivedSib32Nb (false)
{
...
LteUeRrc::DoRecvSystemInformationNb (NbIotRrcSap::SystemInformationNb msg)
{
  ...
  // NTN Rel-17: Parse SIB31-NB (TS 36.331 Sec 6.7.4)
  if (msg.haveSib31)
    {
      m_sib31Nb = msg.sib31;
      m_hasReceivedSib31Nb = true;
      NS_LOG_INFO (this << " UE received SIB31-NB: ta_common=" << msg.sib31.taCommon
                   << " k_offset=" << msg.sib31.kOffset);
    }

  // NTN Rel-17: Parse SIB32-NB (TS 36.331 Sec 6.7.4)
  if (msg.haveSib32)
    {
      m_sib32Nb = msg.sib32;
      m_hasReceivedSib32Nb = true;
    }
