...
private:
  ...
  // NTN Rel-17: SIB31/32 (TS 36.331 Sec 6.7.4)
  bool m_haveSib31Ntn;
  NbIotRrcSap::SystemInformationBlockType31Nb m_sib31Ntn;
  bool m_haveSib32Ntn;
  NbIotRrcSap::SystemInformationBlockType32Nb m_sib32Ntn;

public:
  /**
   * Set SIB31-NB for NTN broadcast (called by NtnConstellationManager).
   */
  void SetNtnSib31 (NbIotRrcSap::SystemInformationBlockType31Nb sib31)
  {
      m_haveSib31Ntn = true;
      m_sib31Ntn = sib31;
  }
  void SetNtnSib32 (NbIotRrcSap::SystemInformationBlockType32Nb sib32)
  {
      m_haveSib32Ntn = true;
      m_sib32Ntn = sib32;
  }
