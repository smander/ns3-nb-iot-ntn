...
/**
  ...
  // NTN Rel-17: SIB31/32 reception state (TS 36.331 Sec 6.7.4)
  bool m_hasReceivedSib31Nb;
  NbIotRrcSap::SystemInformationBlockType31Nb m_sib31Nb;
  bool m_hasReceivedSib32Nb;
  NbIotRrcSap::SystemInformationBlockType32Nb m_sib32Nb;
